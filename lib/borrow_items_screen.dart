  ...
  body: isLoading
      ...
      : hasError
          ...
          : Padding(
              ...
              child: SingleChildScrollView( // Fix for keyboard overflow
                child: Column(
                          ...
                          return DataRow(cells: [
                            DataCell(
                              ElevatedButton(
                                ...
                                onPressed: () async {
                                  String borrowerName =
                                      await _allItemsApi.fetchUserName(empId);
                            ...
                            DataCell(
                                Text(item['serial_no']?.toString() ?? 'N/A')),
                          ]);
                        }).toList(),
                      ),
                    ),
