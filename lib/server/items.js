...
// Fetch distributed_items by emp_id (accountable_emp) lending transaction and transfer Item
...
// Fetch distributed_items based on department ID (for borrowing transaction and return transaction)
