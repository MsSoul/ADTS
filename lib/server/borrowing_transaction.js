...
router.post("/borrow", async (req, res) => {
    try {
        ...
        const [insertResult] = await db.query(
            "INSERT INTO borrowing_transaction (item_id, borrower_emp_id, owner_emp_id, quantity, DPT_ID, createdAt, updatedAt, status) VALUES (?, ?, ?, ?, ?, NOW(), NOW(), 1)",
