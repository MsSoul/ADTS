...
router.post("/borrow", async (req, res) => {
    try {
        ...
        // Insert borrow transaction with `distributed_item_id`
        // Insert borrow transaction with ITEM_ID instead of distributed_item_id
        const [insertResult] = await db.query(
            ...
            [ITEM_ID, borrower_emp_id, owner_emp_id, quantity, DPT_ID]  // ✅ Save ITEM_ID instead of distributed_item_id
        );
